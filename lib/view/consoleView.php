...
class ConsoleView {
    ...
    public function printList(){
            $valid_currency_symbols = $this->model->getValidCurrencies();
    ...
    public function printCurrencyPrice($currency_symbol) {
        $data = $this->model->fetchData("prices/$currency_symbol-USD/spot");
    ...
    public function printCurrencyPairPrice($base_currency, $quote_currency) {
        $data = $this->model->fetchData("prices/$base_currency-$quote_currency/spot");
